...
- 3. What is a PDK?
- 4. SKY130 — An Open-Source PDK
- 5. The EDA Tools Landscape
- 6. Simplified RTL to GDSII Flow
- 7. Introduction to OpenLANE
  - 7.1 The Detailed OpenLANE Flow
  - 7.2 Design for Test (DFT)
  - 7.3 OpenROAD — Automated Place and Route
  - 7.4 Handling Antenna Rule Violations
  - 7.5 Design Space Exploration
- 8. Lab: Exploring the OpenLANE PDK Directory Structure
- 9. Lab: Setting Up OpenLANE
- 10. Lab: Running the OpenLANE Flow on picorv32a
- 11. Takeaways
- Author
...
## 6️⃣ Simplified RTL to GDSII Flow
...
## 8️⃣ Lab: Exploring the OpenLANE PDK Directory Structure
...
## 🔟 Lab: Running the OpenLANE Flow on picorv32a
